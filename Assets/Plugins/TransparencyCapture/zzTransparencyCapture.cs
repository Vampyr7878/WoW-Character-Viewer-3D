...
public class zzTransparencyCapture
{
    ...
    {
        float lAlpha = getAlpha(0.21f * pColorWhenBlack.r + 0.72f * pColorWhenBlack.g + 0.07f * pColorWhenBlack.b, 0.21f * pColorWhenWhite.r + 0.72f * pColorWhenWhite.g + 0.07f * pColorWhenWhite.b);
        return new Color(
