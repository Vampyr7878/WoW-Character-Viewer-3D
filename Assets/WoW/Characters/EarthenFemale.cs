...
{
    // Class to handle earthen female customization
    public class EarthenFemale : CharacterHelper
    {
        public EarthenFemale(M2 model, Character character, ComputeShader shader)
        {
#if UNITY_EDITOR
            textures = new();
#endif
