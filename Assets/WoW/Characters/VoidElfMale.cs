...
namespace WoW.Characters
{
    ...
    public class VoidElfMale : CharacterHelper
    {
        ...
        public VoidElfMale(M2 model, Character character)
        {
            Model = model;
            Character = character;
            skinColorFaces = new()
            {
                ...
                { 326, new int[] { 9761, 9762, 9763, 9764, 9765, 9766, 9767, 9768, 9769, 9770, 9771, 9772, 9773, 9774, 9775, 9776, 9777, 9778, 9779, 9780 } },
                { 646, new int[] { 2832, 2833, 2834, 2835, 2836, 2837, 2838, 2839, 9761, 9762, 9763, 9764, 9765, 9766, 9767, 9768, 9769, 9770 } }
            };
            skinColorEyes = new()
            {
                { 640, new int[] { 28848 } },
                { 642, new int[] { 2824, 2825, 2826, 2829, 2827, 2828, 9689, 9695, 9694, 9688, 9693, 9692, 9691, 9687, 9696, 9690, 9700, 9701, 9702, 9703 } },
                { 644, new int[] { 2824, 2825, 2826, 2829, 2827, 2828, 9689, 9695, 9694, 9688, 9693, 9692, 9691, 9687, 9696, 9690, 9700, 9701, 9702, 9703, 9699, 9697, 9698 } }
            };
