    ...
    public class DraeneiMale : CharacterHelper
    {
        ...
        public DraeneiMale(M2 model, Character character, ComputeShader shader)
        {
            ...
            skinColorFaces = new()
            {
                ...
                { 141, new int[] { 1890, 1891, 1892, 1893, 1894, 1895, 1896, 1897, 1898, 1899,
                    1900, 1901, 1902, 1903, 1904, 1905, 1906, 1907, 1908, 1909 } },
                { 4112, new int[] { 1890, 1891, 1892, 1893, 1894, 1895, 1896, 1897, 1898, 1899,
                    1900, 1901, 1902, 1903, 1904, 1905, 1906, 1907, 1908, 1909 } }
            };
            hairStyleCirclets = new()
            {
                { 141, new int[] { 1910, 1911, 1912, 1913, 1914, 1915, 1916, 1917, 1918, 1919, 1920,
                    1921, 1922, 1923, 7770, 7771, 7772, 7773, 7774, 7775, 7776, 7777, 7778 } },
                { 163, new int[] { 1910, 1911, 1912, 1914, 1915, 1917, 1918, 1920, 1921,
                    1923, 7770, 7772, 7773, 7774, 7775, 7776, 7777, 7778 } },
            };
