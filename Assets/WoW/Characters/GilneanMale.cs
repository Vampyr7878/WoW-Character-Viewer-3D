...
{
    //Class to handle gilnean male customization
    public class GilneanMale : CharacterHelper
    {
        public GilneanMale(M2 model, Character character, CASCHandler casc)
        {
            Model = model;
            Character = character;
        ...
        {
            int index = Array.FindIndex(Character.Options, o => o.Name == "Skin Color" && o.Form == 7);
            int index2 = Array.FindIndex(Character.Options, o => o.Name == "Face" && o.Form == 7);
        ...
        {
            int index = Array.FindIndex(Character.Options, o => o.Name == "Mustache" && o.Form == 7);
        ...
        {
            int index = Array.FindIndex(Character.Options, o => o.Name == "Beard" && o.Form == 7);
            int index2 = Array.FindIndex(Character.Options, o => o.Name == "Sideburns" && o.Form == 7);
        ...
        {
            int index = Array.FindIndex(Character.Options, o => o.Name == "Eyebrows" && o.Form == 7);
        ...
        {
            int index = Array.FindIndex(Character.Options, o => o.Name == "Eye Color" && o.Form == 7);
