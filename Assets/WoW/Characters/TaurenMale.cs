...
namespace WoW.Characters
{
    ...
    {
        public TaurenMale(M2 model, Character character, CASCHandler casc)
        {
            Model = model;
            Character = character;
        ...
        protected override void LayeredTexture(Texture2D texture)
        {
            ...
            {
                Texture2D facial = TextureFromBLP(Character.Choices[index2][Character.Customization[index2]].Textures[Character.Customization[index]].Texture2);
        ...
        protected override int LoadTexture(M2Texture texture, int i, out bool skin)
        {
            ...
            switch (texture.Type)
            {
                ...
                //    break;
                case 6:
                    index = Array.FindIndex(Character.Options, o => o.Name == "Horn Style");
                    index2 = Array.FindIndex(Character.Options, o => o.Name == "Horn Color");
