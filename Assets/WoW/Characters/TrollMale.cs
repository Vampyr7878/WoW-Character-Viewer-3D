...
namespace WoW.Characters
{
    ...
    public class TrollMale : CharacterHelper
    {
        ...
        private void ChangeFacePaint()
        {
            int index = Array.FindIndex(Character.Options, o => o.Name == "Face Paint");
            int index2 = Array.FindIndex(Character.Options, o => o.Name == "Face Paint Color");
            if (Character.Customization[index2] > Character.Choices[index][Character.Customization[index]].Bone)
            {
                while (Character.Customization[index2] > Character.Choices[index][Character.Customization[index]].Bone)
                {
                    Character.Customization[index2]--;
                }
                Character.CustomizationDropdowns[index2].value = Character.Customization[index2];
            }
        ...
        private void ChangePiercing(List<int> activeGeosets)
        {
            int index = Array.FindIndex(Character.Options, o => o.Name == "Piercing");
        ...
        protected override void LayeredTexture(Texture2D texture)
        {
            ...
            index2 = Array.FindIndex(Character.Options, o => o.Name == "Face Paint Color");
            if (Character.Choices[index2][Character.Customization[index2]].Textures[Character.Customization[index]].Texture1 >= 0)
            {
                Texture2D facial = Character.TextureFromBLP(Character.Choices[index2][Character.Customization[index2]].Textures[Character.Customization[index]].Texture1);
