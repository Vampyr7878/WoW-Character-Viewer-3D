...
namespace WoW.Characters
{
    ...
    {
        public MechagnomeMale(M2 model, Character character, CASCHandler casc)
        {
            Model = model;
            Character = character;
        ...
        protected override void LayeredTexture(Texture2D texture)
        {
            ...
            Texture2D facial = TextureFromBLP(Character.Choices[index][Character.Customization[index]].Textures[0].Texture2);
