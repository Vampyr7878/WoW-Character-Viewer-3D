...
namespace WoW.Characters
{
    ...
    public class BloodElfFemale : CharacterHelper
    {
        ...
        public BloodElfFemale(M2 model, Character character, CASCHandler casc)
        {
            Model = model;
            Character = character;
        ...
        protected override void LayeredTexture(Texture2D texture)
        {
            ...
            {
                bracelets = TextureFromBLP(Character.Choices[index][Character.Customization[index]].Textures[0].Texture1);
