...
namespace WoW.Characters
{
    ...
    {
        public UndeadFemale(M2 model, Character character, CASCHandler casc)
        {
            Model = model;
            Character = character;
        ...
        protected override void LayeredTexture(Texture2D texture)
        {
            ...
            //{
                Texture2D bra = TextureFromBLP(Character.Choices[index][Character.Customization[index]].Textures[Character.Customization[index2]].Texture4);
