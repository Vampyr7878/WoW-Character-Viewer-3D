...
namespace WoW.Characters
{
    ...
    public class UndeadFemale : CharacterHelper
    {
        ...
        protected override void LayeredTexture(Texture2D texture)
        {
            ...
            {
                Texture2D bra = Character.TextureFromBLP(Character.Choices[index][Character.Customization[index]].Textures[Character.Customization[index2]].Texture4);
                DrawTexture(texture, bra, 256, 384);
            }
            if (!(Character.Items[3] != null && Character.Items[3].UpperLeg !> 0) && Character.Items[10] == null)
            {
                Texture2D underwear = Character.TextureFromBLP(Character.Choices[index][Character.Customization[index]].Textures[Character.Customization[index2]].Texture3);
            ...
            {
                Texture2D facial = Character.TextureFromBLP(Character.Choices[index][Character.Customization[index]].Textures[0].Texture1);
